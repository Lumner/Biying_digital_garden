...
- [0. 课程视角：从门电路到系统软件](#0-课程视角从门电路到系统软件)
- [1. 信息表示](#1-信息表示)
- [2. 布尔代数与数字逻辑基础](#2-布尔代数与数字逻辑基础)
- [3. 组合逻辑设计与 Verilog HDL](#3-组合逻辑设计与-verilog-hdl)
- [4. 运算部件与 ALU](#4-运算部件与-alu)
- [5. 时序逻辑设计](#5-时序逻辑设计)
- [6. 指令集体系结构 ISA](#6-指令集体系结构-isa)
- [7. RISC-V ISA、汇编与程序运行](#7-risc-v-isa汇编与程序运行)
- [8. 快速查表](#8-快速查表)
- [9. 增量补充区](#9-增量补充区)
...
![计算机系统课程分层](./sys_notes_assets/system_overview.jpg)
...
![ASIC 与 FPGA 设计流](./sys_notes_assets/hdl_design_flow.png)
...
![ALU 符号](./sys_notes_assets/alu_symbol.png)
...
![4 位 barrel shifter 功能表](./sys_notes_assets/barrel_shifter_table.png)
...
![带 EN 的 D 触发器与 4 位寄存器](./sys_notes_assets/register_enable.png)
...
![RISC-V 核心指令格式](./sys_notes_assets/riscv_formats.png)
...
![栈帧结构](./sys_notes_assets/stack_frame.png)
