...
<section class="garden-pagehead">
  ...
  <p class="garden-pagehead__lead">查看注册用户、处理私信、管理公开留言，并为忘记密码的用户签发一次性恢复码。</p>
...
这里不会展示密码、密码哈希或公开以外的内容。恢复码只在生成时显示一次，过期或使用一次后失效。公开留言可在这里隐藏、恢复显示或删除；站主也可以注销用户账号，这会清除账号与当前登录状态，但不会自动抹掉它已经公开发表过的留言。
